    ...
    <>
      ...
      <div className="flex justify-end">
        <button
          ...
          className="flex items-center gap-2 rounded-full bg-[#8B45A6] px-4 py-2.5 text-sm font-semibold text-[#171716] shadow-[0_12px_24px_rgba(139,69,166,0.16)]"
        >
...
function SummaryCard({
  ...
  return (
    <section className={`rounded-[24px] px-4 py-4 shadow-[0_12px_26px_rgba(23,23,22,0.04)] ${accent ? 'bg-[#8B45A6]' : 'border border-[#e6e0d7] bg-white'}`}>
